...
{
    public class OrInstructionTest : IDisposable
    {
        readonly CPU cpu;
        readonly Bus bus;

        public OrInstructionTest()
        {
            this.bus = new Bus();
            this.cpu = bus.GetCPU();
        }
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB7, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB0, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB1, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB2, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB3, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB4, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB5, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xB6, zeroFlag, negative, halfCarry, carryFlag);
            ...
            bool zeroFlag, bool negative, bool halfCarry, bool carryFlag)
        {
            ...
            Execute8bitTest(0xF6, zeroFlag, negative, halfCarry, carryFlag, 0xC002);
